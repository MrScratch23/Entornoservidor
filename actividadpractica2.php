...
// array asociativo para los errores, mas ordenadito 
$errores = [
    'nombre' => '',
    'apellidos' => '',
    'fecha_nacimiento' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['enviar'])) {
        ...
        if (file_exists('usuarios.csv')) {
            ...
            while (($fila = fgetcsv($archivo)) !== FALSE) {
                ...
                if (isset($fila[6]) && trim($fila[6]) === $email) {
                    $errores['email'] = "El email ya fue registrado anteriormente";
                    break;
                }
            }
            fclose($archivo);
    ...
    if (empty($contraseña) && empty($confirmarContraseña)) {
        $errores['password'] = "La contraseña y su confirmacion es obligatoria. ";
...
<body>
    <!-- la mayoria de este codigo html esta hecho con deepseek, salvo las partes de php, espero que no te importe demasiado -->
    <header>
    ...
    <main>
        ...
        <form action="" method="POST">
            ...
            <small class="error <?php echo empty($errores['apellidos']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['fecha_nacimiento']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['genero']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['email']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['password']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['confirmar_password']) ? 'hidden' : ''; ?>">
            ...
            <small class="error <?php echo empty($errores['terminos']) ? 'hidden' : ''; ?>">
