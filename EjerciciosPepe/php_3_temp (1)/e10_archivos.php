...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['enviar'])) {
    ...
    if ($fichero['error'] !== UPLOAD_ERR_OK)  $errores['fichero_imagen'] = "Error al obtener el fichero";
        ...
        elseif ($tamanyo > 1)
            $errores['fichero_imagen'] = "El fichero no puede tener más de 1 MB\n";

        // si todo ha ido correctamente:
        if (empty($errores)) {
            //obtenemos la ruta del fichero (la última parte del fichero)
            //basename toma solo el nombre del fichero sin la ruta.
    ...
    <main>
        ...
        <form action="e10_archivos.php" method="post" enctype="multipart/form-data">
            ...
            <p>
                ...
                <!-- 
                <input type="file" name="fichero_imagen" id="fichero_imagen" accept="image/*">
                <input type="file" name="fichero_imagen" id="fichero_imagen" accept=".jpg,.jpeg,.png"> -->
