...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $color_fondo = htmlspecialchars(trim($_POST['color_fondo'])) ?? '';
    $fuente = htmlspecialchars(trim($_POST['fuente'])) ?? '';
    $estilo_literario = htmlspecialchars(trim($_POST['estilo_literario'])) ?? '';
